...
public class Program
{
    ...
    public (int, int) Task_2_7(int n)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (x > 0 && y > 0)
            {
                Console.WriteLine("1-é êâàäðàíò");
                answer1++;
            }
            else if (x < 0 && y > 0)
            {
                Console.WriteLine("2-é êâàäðàíò");
            }
            else if (x < 0 && y < 0)
            {
                Console.WriteLine("3-é êâàäðàíò");
                answer3++;
            }
            else if (x > 0 && y < 0)
            {
                Console.WriteLine("4-é êâàäðàíò");
            }
        }
        Console.WriteLine("Êîë-âî òî÷åê â 1-é êâàäðàíòå: "+answer1+"\n"+ "Êîë-âî òî÷åê â 3-é êâàäðàíòå: "+answer3);
        // end
    ...
    public (int, double) Task_2_8(int n)
    {
        ...
        Console.WriteLine($"Òî÷êà {answer} : {answerLength}");
        // end
    ...
    public int Task_2_10(int n)
    {
        ...
        Console.WriteLine("×èñëî ñòóäåíòîâ: " + answer);
        // end
    ...
    public (int, double) Task_2_11(int n)
    {
        ...
        Console.WriteLine($"\n×èñëî íåóñïåâàþùèõ ñòóäåíòîâ {answer} è ñðåäíèé áàëë ãðóïïû {avg}");
        // end
    ...
    public double Task_3_3()
    {
        ...
        int k = 0;
        string input;
        Console.WriteLine("Ââåäèòå âåñ (äëÿ îêîí÷àíèÿ ââîäà íàïèøèòå exit):");
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("Íåêîððåêòíûé ââîä, ïîïðîáóéòå ñíîâà");
            }
        }
    ...
    public int Task_3_6()
    {
        ...
        // code here
        Console.WriteLine("Ââåäèòå êîîðäèíàòû òî÷åê (äëÿ îêîí÷àíèÿ ââîäà íàïèøèòå exit):");

        while (true)
        {
            n++;
            Console.WriteLine($"Òî÷êà {n}");
            Console.Write("X: ");
    ...
    public double Task_3_9()
    {
        ...
        // code here
        Console.WriteLine("Ââåäèòå ðåçóëüòàò ñïîðòñìåíîâ (äëÿ îêîí÷àíèÿ ââîäà íàïèøèòå exit):");

        while (true)
        {
            Console.Write("Ðåçóëüòàò: ");
        ...
        Console.WriteLine($"Ëó÷øèé ðåçóëüòàò: {answer} ñ");
        // end
